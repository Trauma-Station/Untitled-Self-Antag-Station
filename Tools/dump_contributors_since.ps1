...
$engine = & "$PSScriptRoot\dump_commits_since.ps1" -repo Trauma-Station/QuietToolbox -since $since -until $until
$content = & "$PSScriptRoot\dump_commits_since.ps1" -repo Trauma-Station/Untitled-Self-Antag-Station -since $since -until $until
