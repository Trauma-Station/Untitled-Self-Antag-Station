...
public sealed partial class BloodstreamSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        // </Trauma>
        {
            ...
            if (!_solutionContainer.ResolveSolution(uid, bloodstream.BloodSolutionName, ref bloodstream.BloodSolution, logMissing: false)) // Trauma - dont log missing
    ...
    private void OnRejuvenate(Entity<BloodstreamComponent> ent, ref RejuvenateEvent args)
    {
        ...
        DirtyFields(ent.AsNullable(), null,
            ...
            nameof(BloodstreamComponent.BleedAmountNotFromWounds));
        // </Trauma>
