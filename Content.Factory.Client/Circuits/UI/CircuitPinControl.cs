...
public sealed class CircuitPinControl : PanelContainer
{
    ...
    private static readonly ResPath InputTexture = new("/Textures/_Factory/Interface/circuits_input_pin.png");
    private static readonly ResPath OutputTexture = new("/Textures/_Factory/Interface/circuits_output_pin.png");
